...
The following are only needed if you wish to "compile" MMBNO into OS native
executable files:
...
http://sourceforge.net/tracker/?group_id=271249&atid=1153459

============================
WANT TO HELP?
============================

MMBNO is something that's done at our spare time, so we can't dedicate all the
time of day toward it. If you have experience with programming in
Python, and know how to o are willing to learn how to use the Pyglet library,
then it would be great to get a few helping hands to aid in mainstream
...
Thank you for using MMBN Online. While it may not seem like it,
bug reports are actually huge contributions.
