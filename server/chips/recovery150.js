...
function Recovery150Constructor(io, config, game, character, code) {
...
module.exports = function Recovery150(io, config, game, character, code) {
    return extend(Recovery150Constructor, RecoveryType, io, config, game, character, code);
};
