...
function MegaCannonConstructor(io, config, game, character, code) {
...
module.exports = function MegaCannon(io, config, game, character, code) {
    return extend(MegaCannonConstructor, CannonType, io, config, game, character, code);
};
