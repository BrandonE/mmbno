...
function Vulcan3Constructor(io, config, game, character, code) {
...
module.exports = function Vulcan3(io, config, game, character, code) {
    return extend(Vulcan3Constructor, VulcanType, io, config, game, character, code);
};
