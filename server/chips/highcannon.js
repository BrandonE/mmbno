...
function HighCannonConstructor(io, config, character) {
...
module.exports = function HighCannon(io, config, character) {
    return extend(HighCannonConstructor, CannonType, io, config, character);
};
