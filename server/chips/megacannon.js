...
function MegaCannonConstructor(io, config, character) {
...
module.exports = function MegaCannon(io, config, character) {
    return extend(MegaCannonConstructor, CannonType, io, config, character);
};
