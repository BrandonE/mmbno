...
function Spreader2Constructor(io, config, game, character, code) {
...
module.exports = function Spreader2(io, config, game, character, code) {
    return extend(Spreader2Constructor, SpreaderType, io, config, game, character, code);
};
