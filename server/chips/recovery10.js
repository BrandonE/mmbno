...
function Recovery10Constructor(io, config, game, character, code) {
...
module.exports = function Recovery10(io, config, game, character, code) {
    return extend(Recovery10Constructor, RecoveryType, io, config, game, character, code);
};
