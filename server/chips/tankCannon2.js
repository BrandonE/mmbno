...
function TankCannon2Constructor(io, config, game, character, code) {
...
module.exports = function TankCannon2(io, config, game, character, code) {
    return extend(TankCannon2Constructor, TankCannonType, io, config, game, character, code);
};
