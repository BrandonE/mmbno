...
function Vulcan1Constructor(io, config, game, character) {
...
module.exports = function Vulcan1(io, config, game, character) {
    return extend(Vulcan1Constructor, VulcanType, io, config, game, character);
};
