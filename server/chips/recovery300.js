...
function Recovery300Constructor(io, config, game, character, code) {
...
module.exports = function Recovery300(io, config, game, character, code) {
    return extend(Recovery300Constructor, RecoveryType, io, config, game, character, code);
};
