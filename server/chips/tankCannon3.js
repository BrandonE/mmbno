...
function TankCannon3Constructor(io, config, game, character) {
...
module.exports = function TankCannon3(io, config, game, character) {
    return extend(TankCannon3Constructor, TankCannonType, io, config, game, character);
};
