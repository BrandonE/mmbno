...
function Recovery80Constructor(io, config, game, character, code) {
...
module.exports = function Recovery80(io, config, game, character, code) {
    return extend(Recovery80Constructor, RecoveryType, io, config, game, character, code);
};
